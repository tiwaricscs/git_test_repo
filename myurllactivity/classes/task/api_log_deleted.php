 ...
 */
namespace mod_myurllactivity\task;
...
class api_log_deleted extends \core\task\scheduled_task {
    public function execute() {
        global $DB;
        $condition = array('eventname' == '\mod_myurllactivity\event\course_module_viewed');
        $DB->delete_records('logstore_standard_log', $condition);
    }
    public function get_name(): string {
        return get_string('schedule_alert', 'myurllactivity');
    }
}
?> 