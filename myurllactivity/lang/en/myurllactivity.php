...
$string['modulename'] = 'myurllactivity';
...
$string['pluginname'] = 'myurllactivity';
$string['iframeheight'] = 'Iframe height (in pixels)';
$string['iframeheightexplain'] = 'Specifies default height of iframe windows.';
$string['iframewidth'] = 'Iframe width (in pixels)';
$string['iframewidthexplain'] = 'Specifies default width of iframe windows.';
...
$string['search:activity'] = 'MYURLLACTIVITY';
$string['serverurl'] = 'Server MYURLLACTIVITY';
$string['url:addinstance'] = 'Add a new MYURLLACTIVITY resource';
$string['url:view'] = 'View URL';
$string['courseid']= 'Course id';
$string['userid'] = 'User id';
$string['schedule_alert'] = 'API logs are deleted';
$string['completion_subject']= 'student have succesfully completed the course';
$string['completion'] = 'regarding activity completion';
